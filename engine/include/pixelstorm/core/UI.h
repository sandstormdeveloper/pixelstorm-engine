...
public:
    ...
    static void Print(const std::string &text, const Vec2 &position, const Color &color = Colors::White(), float scale = 1.0f); // Queues text to be drawn by the application
